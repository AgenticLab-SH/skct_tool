(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        helpModal: {
            ...
            step2Title: '문제 풀기',
            step2Body: '문제 자료를 옆에 두고 전체·과목 시간을 맞춥니다.',
            step3Title: '필요한 도구 쓰기',
            step3Body: '문제를 풀며 화면의 <b>계산기, 메모장, 그림판</b>을 번갈아 사용합니다.',
            step4Title: '끝난 뒤 채점',
            step4Body: '채점이 필요할 때만 왼쪽 <b>답안 기록</b>에서 내 답과 정답을 입력합니다.',
            exampleSectionTitle: '📷 추천 화면 배치',
            pdfTitle: 'PDF 활용',
            pdfCaption: '좌측에 PDF를 띄우고, 우측에서 타이머·메모장과 함께 연습합니다.',
            omrTitle: '채점용 답안 기록',
            omrCaption: '실제 시험 기능이 아니라, 개인 자료를 채점할 때만 쓰는 편의 기능입니다.',
            ...
            referenceBlockHtml: '<strong style="color:#1e293b;">알아두세요</strong><br>이 도구는 실제 시험 중 함께 사용하는 프로그램이 아닙니다. 가지고 있는 연습 자료로 계산기, 메모장, 그림판과 시간 관리 흐름을 미리 익히는 개인 제작 도구입니다. 왼쪽 답안 기록은 개인 채점을 위한 편의 기능이며 실제 시험 화면에는 없습니다.',
            featureSectionTitle: '핵심 버튼 위치',
            sidebarFeatureHtml: '<strong>처음에는 두 가지만 확인하세요</strong>\n<p><b>설정</b>: 전체 시간과 과목 시간을 바꾸는 곳</p>\n<p><b>팝업</b>: 문제 자료 옆에 연습 도구를 따로 여는 곳</p>\n<p><b>답안</b>: 연습이 끝난 뒤 채점이 필요할 때만 여는 곳</p>',
        ...
        advancedGuide: {
            ...
            featureTitle: '고급 모드 전체 기능',
            featureCard1Html: '<span>화면</span><strong>팝업 비율·배치</strong><small>연습 도구의 폭과 위치 조정</small>',
            featureCard2Html: '<span>시간</span><strong>문항 시간·반복 제어</strong><small>이전 과목, 처음부터, 시간 가이드</small>',
            featureCard3Html: '<span>채점</span><strong>정오표·상세 통계</strong><small>CBT 붙여넣기, 과목별·문항별 분석</small>',
            featureCard4Html: '<span>기록</span><strong>회차별 보관함</strong><small>계정별 결과 저장과 다시 보기</small>',
            featureAccessHtml: '<strong>연습 결과가 다음 회차로 이어집니다.</strong><br>문항 시간, 과목별 통계, 오답 이유와 성장 흐름을 실제 저장 데이터로 확인할 수 있습니다.',
            planTitle: '신청 순서 1 - 이용권 안내',
            planIntro: '타이머, 계산기, 메모장, 그림판과 기본 채점은 무료입니다. 여러 회차를 저장하고 비교하고 싶을 때만 고급 이용권을 선택하세요.',
            donateButton: '후원하기',
            flowHtml: '이용권 선택 → 신청서 입력 → 1. 후원 내용 복사 → 2. 후원하기 → 3. 후원완료',
            formTitle: '신청 순서 2 - 신청서 작성',
            formDescription: '이용권과 로그인 정보를 입력한 뒤 1. 후원 내용 복사, 2. 후원하기, 3. 후원완료 순서로 진행해주세요. 승인 결과는 이메일로 알려드립니다.',
        ...
        advancedFeature: {
            title: '✨ 고급 활용',
            introHtml: '',
            summaryHtml: '<strong>회차 저장</strong> → <strong>문항 시간 분석</strong> → <strong>오답 원인 정리</strong> → <strong>성장 흐름 확인</strong>',
            planHtml: '',
            image1Title: '1. 상단 상태와 실제환경 여백',
            image1Caption: '고급 ON, 로그인 상태, 이용권 정보를 확인하고 실제 화면에 가까운 우측 여백으로 연습합니다.',
            image2Title: '2. 채점 뒤 기록과 분석',
            image2Caption: '정오표 입력, 과목별 통계, 문항 시간, 기록 보관함과 성장 분석이 한 흐름으로 이어집니다.',
            flowButton: '신청 안내',
            statsButton: 'TXT 다운로드',
            feature1Html: '<strong>1. 회차와 문항 기록 저장</strong><br>결과, 문항별 소요 시간과 메모를 개인 보관함에서 다시 봅니다.',
            feature2Html: '<strong>2. 약점과 시간 사용 분석</strong><br>과목별 정답률, 오래 걸린 문항과 시간 압박 구간을 함께 확인합니다.',
            feature3Html: '<strong>3. 오답 원인과 성장 흐름</strong><br>오답 이유를 태그로 모으고 실제 회차 기록의 변화를 그래프로 비교합니다.',
            feature4Html: '<strong>4. 빠른 복기와 반복 연습</strong><br>CBT 정오표, 이전 과목·처음부터, 시간 가이드와 CSV·노션용 표를 활용합니다.'
        },
        advancedMode: {
            ...
            footnoteHtml: '채점한 기록은 <strong>보관함 저장</strong>으로 바로 연결할 수 있고, 고급 모드에서 열린 창이면 계정도 자동으로 확인합니다.',
    ...
    const SITE_TEXT_CATALOG = [
        ...
        { key: 'sidebar.omrLabelHtml', label: '사이드바: 답안 기록', category: '메인 진입', selector: '#sidebarOmrLabel', prop: 'html', multiline: true },
        ...
        { key: 'tools.omrCollapseButton', label: '답안 기록 접기 버튼', category: '답안 기록/도구', selector: '#omrCollapseBtn', prop: 'text' },
        { key: 'tools.omrModeLabel', label: '답안 기록 기본 상태', category: '답안 기록/도구', selector: '#omrModeLabel', prop: 'text' },
        { key: 'tools.skipButton', label: '문항 건너뛰기 버튼', category: '답안 기록/도구', selector: '#globalClearBtn', prop: 'text' },
        { key: 'tools.modeToggleButton', label: '정답 입력 버튼', category: '답안 기록/도구', selector: '#modeToggleBtn', prop: 'text' },
        { key: 'tools.scoreButton', label: '채점 버튼', category: '답안 기록/도구', selector: '#scoreBtn', prop: 'text' },
        { key: 'tools.detailStatsButton', label: '상세 통계 버튼', category: '답안 기록/도구', selector: '#detailScoreBtn', prop: 'text' },
        { key: 'tools.statsDownloadButton', label: 'TXT 저장 버튼', category: '답안 기록/도구', selector: '#advancedStatsDownloadBtn', prop: 'text' },
        { key: 'tools.statsCsvExportButton', label: 'CSV 저장 버튼', category: '답안 기록/도구', selector: '#advancedStatsCsvBtn', prop: 'text' },
        { key: 'tools.statsCsvImportButton', label: 'CSV 불러오기 버튼', category: '답안 기록/도구', selector: '#advancedStatsCsvImportBtn', prop: 'text' },
        { key: 'tools.statsServerButton', label: '문항별 통계 보관함 저장 버튼', category: '답안 기록/도구', selector: '#advancedStatsServerBtn', prop: 'text' },
        { key: 'tools.statsCsvServerButton', label: '성장 기록 보관함 저장 버튼', category: '답안 기록/도구', selector: '#advancedStatsCsvServerBtn', prop: 'text' },
        { key: 'tools.statsCsvImportServerButton', label: '불러온 기록 보관함 반영 버튼', category: '답안 기록/도구', selector: '#advancedStatsCsvImportServerBtn', prop: 'text' },
        { key: 'tools.bulkImportButton', label: '정오표 일괄입력 버튼', category: '답안 기록/도구', selector: '#bulkCorrectImportBtn', prop: 'text' },
        { key: 'tools.resetButton', label: 'RESET 버튼', category: '답안 기록/도구', selector: '#omrResetBtn', prop: 'text' },
        { key: 'tools.statSummaryLabel', label: '채점 결과: 맞은/푼/전체', category: '답안 기록/도구', selector: '#statSummaryLabel', prop: 'text' },
        { key: 'tools.statRateAttemptedLabel', label: '채점 결과: 시도 대비', category: '답안 기록/도구', selector: '#statRateAttemptedLabel', prop: 'text' },
        { key: 'tools.statRateOverallLabel', label: '채점 결과: 전체 대비', category: '답안 기록/도구', selector: '#statRateOverallLabel', prop: 'text' },
        { key: 'tools.statSkippedLabel', label: '채점 결과: 건너뜀', category: '답안 기록/도구', selector: '#statSkippedLabel', prop: 'text' },
        { key: 'tools.statUnansweredLabel', label: '채점 결과: 못 푼 문제', category: '답안 기록/도구', selector: '#statUnansweredLabel', prop: 'text' },
        { key: 'tools.notepadTab', label: '메모장 탭', category: '답안 기록/도구', selector: '#tabNotepad', prop: 'text' },
        { key: 'tools.canvasTab', label: '그림판 탭', category: '답안 기록/도구', selector: '#tabCanvas', prop: 'text' },
        { key: 'tools.clearToolButton', label: '도구 삭제 버튼', category: '답안 기록/도구', selector: '#clearCurrentToolBtn', prop: 'text' },
        { key: 'tools.notepadPlaceholder', label: '메모장 placeholder', category: '답안 기록/도구', selector: '#notepad', prop: 'placeholder', visual: false },
        { key: 'tools.calculatorPanelLabel', label: '계산기 제목', category: '답안 기록/도구', selector: '.section-panel-label', prop: 'text' },
        ...
        { key: 'helpModal.omrTitle', label: '채점용 답안 기록 제목', category: '가이드 모달', selector: '#helpOmrExampleTitle', prop: 'text' },
        { key: 'helpModal.omrCaption', label: '채점용 답안 기록 설명', category: '가이드 모달', selector: '#helpOmrExampleCaption', prop: 'text' },
